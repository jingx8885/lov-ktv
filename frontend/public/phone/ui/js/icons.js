...
export const ICO = {
  ...
  loading:
    '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4a8 8 0 108 8" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"/></svg>',
  listen:
...
export function paintTopRoom(code) {
  const unbound = nativePhone() && !tvBound();
